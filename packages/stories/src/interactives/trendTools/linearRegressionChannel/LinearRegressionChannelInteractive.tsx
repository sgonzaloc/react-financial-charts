...
import { LinearRegressionChannel } from "@react-financial-charts/interactive";
import { format } from "d3-format";

interface LinearRegressionChannelInteractiveProps {
...
interface LinearRegressionChannelInteractiveState {
    channels: any[];
    mode: "draw" | "select";
}

class LinearRegressionChannelInteractive extends React.Component<
    LinearRegressionChannelInteractiveProps,
    LinearRegressionChannelInteractiveState
> {
    ...
    private handleDrawComplete = (e: any, newChannels: any[]) => {
        console.log("handleDrawComplete", newChannels);
            ...
            <div style={{ height: "100%", width: "100%", display: "flex", flexDirection: "column" }}>
                ...
                >
                    <button onClick={() => this.setMode("draw")} style={buttonStyle(mode === "draw")}>
                        <span style={{ marginRight: "8px" }}>📈</span>Draw Channel
                    </button>
...
export default withOHLCData()(
    withSize({ style: { minHeight: 600, width: "100%" } })(withDeviceRatio()(LinearRegressionChannelInteractive)),
);
