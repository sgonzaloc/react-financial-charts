# React 18 Upgrades - Preparing Migration to React 19 compatibility

> This document outlines the upgrades made on Reeact 18, for preparing migration to React 19 in react-financial-charts.

## Summary

The upgrades on React 18, for preparing migration to React 19 was **successful** with no unresolvable blockers. All packages build successfully and are ready for React 19.
...
-   **Storybook packages**: `^6.1.20` → `^8.6.0`
...
2. The `react-19` branch can be reverted
...
**Status**: ✅ **READY FOR REACT 19, the only mising updates are the core react dependencies **
